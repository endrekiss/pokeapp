    ...
    <b-card no-body>
      ...
      <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card no-body >
            <b-list-group flush>
              <b-list-group-item v-for="ability in pokemon.abilities" :key="ability.url" href="#">{{ ability.ability.name }}</b-list-group-item>
            </b-list-group>
          </b-card>
        </b-card-body>
      </b-collapse>
    ...
    <b-card no-body>
      ...
      <b-collapse id="accordion-2" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card no-body >
            <b-list-group flush>
              <b-list-group-item v-for="stat in pokemon.stats" :key="stat.stat.name" href="#">{{ stat.stat.name }} {{ stat['base_stat'] }}</b-list-group-item>
            </b-list-group>
          </b-card>
        </b-card-body>
      </b-collapse>
    ...
    <b-card no-body>
      ...
      <b-collapse id="accordion-4" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
          ...
          <b-list-group flush>
            <b-list-group-item v-for="(item, index) in pokemon.sprites.versions" v-bind:key="index" href="#">
              {{ index }}
    ...
    <b-card no-body>
      ...
      <b-collapse id="accordion-5" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card no-body >
            <b-list-group flush>
              <b-list-group-item v-for="mytype in pokemon.types" :key="mytype.slot" href="#">{{ mytype.type.name }}</b-list-group-item>
            </b-list-group>
          </b-card>
        </b-card-body>
      </b-collapse>
